# Building instructions for the PostgreSQL Docker image
...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/postgresql:16.0-bullseye 16.0/debian/default/
```
...
docker push nicoherbigde/postgresql:16.0-bullseye
```
